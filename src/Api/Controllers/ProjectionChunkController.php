...
/**
 * POST /api/flatrate-wiki/projection/chunk — bounded chunk; no active mutation.
 */
final class ProjectionChunkController implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            $result = $this->projection->chunk($body);
