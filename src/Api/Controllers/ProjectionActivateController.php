...
/**
 * POST /api/flatrate-wiki/projection/activate — compare-and-switch.
 */
final class ProjectionActivateController implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            $result = $this->projection->activate($body);
