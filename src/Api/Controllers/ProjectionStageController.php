...
/**
 * POST /api/flatrate-wiki/projection/stage — manifest only; never activates.
 */
final class ProjectionStageController implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            $result = $this->projection->stage($body);
